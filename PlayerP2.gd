...
func _physics_process(_delta: float) -> void:
	...
	if Input.is_action_just_pressed("Left P2"):
		$Character.flip_h = true
		
	elif Input.is_action_just_pressed("Right P2"):
